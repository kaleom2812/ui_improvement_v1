...
// Only the parameters GET /admin/entitlements documents are forwarded — anything
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const backendRes = await fetch(`${apiUrl}/admin/entitlements${query ? `?${query}` : ""}`, {
      method: "GET",
    ...
    console.error("[API/admin/entitlements] Error:", error instanceof Error ? error.message : error);
