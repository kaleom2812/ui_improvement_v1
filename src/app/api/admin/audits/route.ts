...
// Only the parameters GET /admin/audits documents are forwarded — anything else
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const backendRes = await fetch(`${apiUrl}/admin/audits${query ? `?${query}` : ""}`, {
      method: "GET",
    ...
    console.error("[API/admin/audits] Error:", error instanceof Error ? error.message : error);
